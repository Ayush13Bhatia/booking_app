...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) async {
      Future.wait([
        context.read<HomeViewModel>().bookingListApi(),
        if (mounted) context.read<HomeViewModel>().packageListApi(),
      ]);
    });
  }
  ...
  Widget build(BuildContext context) {
    return DrawerAnimationWidget(
      child: ClipRRect(
        borderRadius: BorderRadius.circular(!context.read<HomeViewModel>().isAnimatePage ? 0 : 20.0),
        child: Scaffold(
